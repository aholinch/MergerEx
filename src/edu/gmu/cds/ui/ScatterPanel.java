 ...
 *
 */
public class ScatterPanel extends JPanel implements QuaternionRotator, PublicPainter
{
    private static final long serialVersionUID = 1L;
    
    public static final Color MY_RED = new Color(255,0,0,50);
    public static final Color MY_BLUE = new Color(0,0,255,50);
    ...
    protected boolean paintAxes = false;
    ...
    @SuppressWarnings("unchecked")
	public ScatterPanel clone(boolean includeData)
    {
        ScatterPanel sp = new ScatterPanel();
        sp.setDataRange(this.minx,this.maxx,this.miny,this.maxy);
        if(includeData)
	...
	public void paintComponent(Graphics gr)
    {
    	...
    	paintComponent(gr,height,width);
    }
    
    @SuppressWarnings("unchecked")
    public void paintComponent(Graphics gr, int height, int width)
    {
